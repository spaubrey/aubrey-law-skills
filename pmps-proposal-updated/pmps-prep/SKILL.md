...
**Couples** (gross estate > $2M): compute two scenarios:
- Scenario 1 (Without Planning): full estate taxed at second death
- Scenario 2 (With Credit Shelter): $2M bypass trust at first death, remainder at second
- Savings = Scenario 1 netTax − Scenario 2 totalNetTax

**Individuals** (gross estate > $2M): compute one scenario (tax at death). Set
...
- **Considerations** — populate `considerations` with talking points: `ilit`,
  `beneficiaryDesignations`, `anticipatedInheritance`,
